...
public final class UiTheme {
    public static final int BG = argb(248, 10, 13, 21);
    public static final int PANEL = argb(247, 17, 21, 31);
    public static final int PANEL_2 = argb(252, 23, 28, 40);
    public static final int CARD = argb(243, 29, 35, 48);
    public static final int CARD_HOVER = argb(255, 39, 46, 61);
    ...
    private static final int LOGO_WIDTH = 720;
    private static final int LOGO_HEIGHT = 610;
